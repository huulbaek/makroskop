...
cp "$ROOT"/cloud/setup.sh "$ROOT"/cloud/run.sh "$ROOT"/cloud/run_batch2.sh "$ROOT"/cloud/run_batch3.sh "$ROOT"/cloud/run_batch4.sh "$ROOT"/cloud/run_all_2030.sh "$ROOT"/cloud/relaunch_after_stage.sh "$STAGE/cloud/"
